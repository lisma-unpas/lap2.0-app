            ...
            {items.map((plan) => (
                <AriaRadio
                    ...
                    className={({ isDisabled, isSelected, isFocusVisible }) =>
                        cx(
                            "relative flex cursor-pointer rounded-lg bg-primary p-4 outline-focus-ring ring-inset transition-all duration-200",
                            size === "md" ? "gap-3" : "gap-2",
                ...
                >
                    {({ isSelected, isDisabled, isFocusVisible }) => (
                        <div className="flex flex-col w-full gap-4">
                            ...
                            {plan.image && (
                                <div className="ml-7 md:ml-8 overflow-hidden rounded-lg border border-secondary shadow-sm">
                                    <img
                                        src={plan.image}
                                        alt={plan.title}
                                        className="w-full h-40 sm:h-80 object-cover hover:scale-105 transition-transform duration-500"
                                    />
                                </div>
                            )}
                        </div>
